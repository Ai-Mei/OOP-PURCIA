...
# Import string and generate ascii letters
import string

# Make a list for letters
letter_list = list(string.ascii_uppercase)

# Make a dictionary of (1) Assignment of alphabet letters to 0-25 and (2) Assignment of numbers 0-25 to alphabet letters.
letter_to_index = dict(zip(letter_list, range(len(letter_list))))
index_to_letter = dict(zip(range(len(letter_list)), letter_list))



# Encryption and decyption of the user_message.
...
def main():
# Ask the user for message and keyword and save the data as user_message and user_keyword and format the input as uppercase.
    print("\33[1mJust a simple reminder, I could only accept words without spaces and I also prefer it to be in uppercase.\nHowever, if you type in lowercase, I think I could do something about it.\nJust make sure to type in ONLY LETTERS.\n")
...
# Print out the message and keyword inputted by the user.
